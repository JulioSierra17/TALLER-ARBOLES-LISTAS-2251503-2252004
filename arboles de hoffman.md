...
1.Son árboles binarios: Cada nodo solo puede tener máximo dos hijos.

2.Sin prefijos: Ningún código es el inicio de otro, así la computadora no se confunde al leer los datos.

3.Eficiencia: Es una de las formas más eficientes de ahorrar espacio en textos.

## ¿Dónde se usan hoy en día?
Aunque no los veamos, los usamos todo el tiempo en:

1.Archivos comprimidos .ZIP o .RAR.

2.Formatos de imágenes como JPEG.

3.Archivos de música y video.
